# References / Bundled — 内置全文

> last_license_review: 2026-04-15
> **v0.2 仅记录计划与 License 状态，实际文件待 License 逐项核对后在 v0.3 加入。**
...
|---|---|---|---|
| **YC Post-Money SAFE 2018**（Cap / Discount / MFN 四个变体 PDF） | YC 公开授权任意使用 | 🟢 候选 | 从 https://www.ycombinator.com/documents 下载最新 PDF 链接记录 |
...
在 bundled 文件就绪前：
- **YC SAFE**：`references/index/05-fundraising.md` § YC Post-Money SAFE → URL 跳转
